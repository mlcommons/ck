...
RUN cm run script --tags=app,mlperf,inference,generic,reference,_retinanet,_onnxruntime,_cpu,_cpp --adr.compiler.tags=gcc --adr.inference-src.tags=_octoml --fake_run
RUN cm run script --tags=app,mlperf,inference,generic,reference,_retinanet,_onnxruntime,_cpu,_cpp --adr.compiler.tags=gcc --adr.inference-src.tags=_octoml
