...
#### CM CLI
`cm run script --tags=destroy,terraform,cmd(,variations from below) (flags from below)`

*or*

`cm run script "destroy terraform cmd (variations from below)" (flags from below)`
