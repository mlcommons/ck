...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-dataset-imagenet-train)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *get,imagenet,train,dataset,original*
* Output cached?: *True*
___
### Usage
...
1. `cm run script --tags=get,imagenet,train,dataset,original [--input_flags]`

2. `cm run script "get imagenet train dataset original" [--input_flags]`

3. `cm run script 2bec165da5cc4ebf [--input_flags]`
...
```cm run script --tags=gui --script="get,imagenet,train,dataset,original"```
...
<summary>Click here to expand this section.</summary>
  ...
  1. ***Run "postrocess" function from [customize.py](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-dataset-imagenet-train/customize.py)***
  1. Read "post_deps" on other CM scripts from [meta](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-dataset-imagenet-train/_cm.json)
</details>
