...
`cm run script --tags=get,lib-armnn,lib,armnn(,variations from below) (flags from below)`

*or*

`cm run script "get lib-armnn lib armnn (variations from below)" (flags from below)`

*or*

`cm run script 9603a2e90fd44587`
...
```cm run script --tags=gui --script="get,lib-armnn,lib,armnn"```
