...
#### CM CLI
`cm run script --tags=get,dataset,criteo,recommendation,dlrm,preprocessed(,variations from below) (flags from below)`

*or*

`cm run script "get dataset criteo recommendation dlrm preprocessed (variations from below)" (flags from below)`
