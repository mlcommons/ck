...
`cm run script --tags=print,hello-world,hello world,hello,world,script(,variations from below) (flags from below)`

*or*

`cm run script "print hello-world hello world hello world script (variations from below)" (flags from below)`
