...
1. `cm run script --tags=get,dataset,medical-imaging,kits,original,kits19[,variations] `

2. `cm run script "get dataset medical-imaging kits original kits19[,variations]" `

3. `cm run script 79992bb221024ac5 `
