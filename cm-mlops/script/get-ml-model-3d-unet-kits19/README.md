...
2. `cm run script "get ml-model raw 3d-unet kits19 medical-imaging[,variations]" `

3. `cm run script fb7e31419c0f4226 `
...
```cm run script --tags=gui --script="get,ml-model,raw,3d-unet,kits19,medical-imaging"```
