...
* CM "database" tags to find this script: *app,image-classification,python,torch*
* Output cached? *False*
___
...
1. `cm run script --tags=app,image-classification,python,torch[,variations] `

2. `cmr "app image-classification python torch[ variations]" `
