...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-cmsis_5)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *get,cmsis,cmsis_5,arm-software*
* Output cached?: *True*
___
### Usage
...
`cm run script --tags=get,cmsis,cmsis_5,arm-software(,variations from below) (flags from below)`

*or*

`cm run script "get cmsis cmsis_5 arm-software (variations from below)" (flags from below)`
...
```cm run script --tags=gui --script="get,cmsis,cmsis_5,arm-software"```
