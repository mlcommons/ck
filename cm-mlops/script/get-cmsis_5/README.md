...
1. `cm run script --tags=get,cmsis,cmsis_5,arm-software[,variations] `

2. `cm run script "get cmsis cmsis_5 arm-software[,variations]" `

3. `cm run script 2258c212b11443f5 `
