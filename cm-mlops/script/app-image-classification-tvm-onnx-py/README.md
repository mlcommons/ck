...
1. `cm run script --tags=app,image-classification,tvm-onnx,python[,variations] `

2. `cm run script "app image-classification tvm-onnx python[,variations]" `

3. `cm run script 63080407db4d4ac4 `
...
```cm run script --tags=gui --script="app,image-classification,tvm-onnx,python"```

Use this [online GUI](https://cKnowledge.org/cm-gui/?tags=app,image-classification,tvm-onnx,python) to generate CM CMD.
