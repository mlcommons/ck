...
2. `cm run script "get dataset criteo original[,variations]" [--input_flags]`

3. `cm run script 194a47d908714897 [--input_flags]`
...
```cm run script --tags=gui --script="get,dataset,criteo,original"```
