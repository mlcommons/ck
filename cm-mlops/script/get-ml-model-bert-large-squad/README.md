...
* CM "database" tags to find this script: *get,ml-model,bert,bert-large,bert-squad,language,language-processing*
* Output cached?: *True*
___
### Usage
...
#### CM CLI
`cm run script --tags=get,ml-model,bert,bert-large,bert-squad,language,language-processing(,variations from below) (flags from below)`

*or*

`cm run script "get ml-model bert bert-large bert-squad language language-processing (variations from below)" (flags from below)`
