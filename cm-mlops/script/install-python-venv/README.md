...
2. `cm run script "install python get-python-venv python-venv[,variations]" `

3. `cm run script 7633ebada4584c6c `
...
```cm run script --tags=gui --script="install,python,get-python-venv,python-venv"```
