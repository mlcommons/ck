...
RUN cm run script --tags=app,mlperf,inference,generic,reference,_retinanet,_onnxruntime,_cpu,_python --adr.compiler.tags=gcc --mode=$CM_LOADGEN_MODE --scenario=$CM_LOADGEN_SCENARIO --test_query_count=$CM_TEST_QUERY_COUNT
