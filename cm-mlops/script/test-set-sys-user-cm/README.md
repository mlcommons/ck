...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/test-set-sys-user-cm)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *demo,set,sys-user,cm,sys-user-cm*
* Output cached?: *True*
___
### Usage
...
`cm run script --tags=demo,set,sys-user,cm,sys-user-cm(,variations from below) (flags from below)`

*or*

`cm run script "demo set sys-user cm sys-user-cm (variations from below)" (flags from below)`
...
```cm run script --tags=gui --script="demo,set,sys-user,cm,sys-user-cm"```
