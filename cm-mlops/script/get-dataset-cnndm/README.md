...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-dataset-cnndm)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *get,dataset,gpt-j,cnndm,cnn-dailymail,original*
* Output cached?: *True*
___
### Usage
...
1. `cm run script --tags=get,dataset,gpt-j,cnndm,cnn-dailymail,original[,variations] `

2. `cm run script "get dataset gpt-j cnndm cnn-dailymail original[,variations]" `

3. `cm run script aed298c156e24257 `
...
```cm run script --tags=gui --script="get,dataset,gpt-j,cnndm,cnn-dailymail,original"```
...
<summary>Click here to expand this section.</summary>
  ...
  1. ***Read "deps" on other CM scripts from [meta](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-dataset-cnndm/_cm.json)***
     * get,sys-utils-cm
  ...
  1. Read "post_deps" on other CM scripts from [meta](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-dataset-cnndm/_cm.json)
</details>
