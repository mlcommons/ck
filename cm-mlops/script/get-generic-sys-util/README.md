...
### Tags
* All CM script tags: *get,sys-util,generic,generic-sys-util*
* CM CLI: *`cm run script --tags="get,sys-util,generic,generic-sys-util"`*
* CM CLI alternative: *`cm run script "get sys-util generic generic-sys-util"`*
