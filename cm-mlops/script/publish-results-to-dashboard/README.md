...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/publish-results-to-dashboard)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *publish-results,dashboard*
* Output cached?: *False*
___
### Usage
...
`cm run script --tags=publish-results,dashboard(,variations from below) (flags from below)`

*or*

`cm run script "publish-results dashboard (variations from below)" (flags from below)`
...
```cm run script --tags=gui --script="publish-results,dashboard"```
