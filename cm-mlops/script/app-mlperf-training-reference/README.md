...
2. `cm run script "app vision language mlcommons mlperf training reference ref[,variations]" [--input_flags]`

3. `cm run script 0c4b11bdcf494b4f [--input_flags]`
...
```cm run script --tags=gui --script="app,vision,language,mlcommons,mlperf,training,reference,ref"```
