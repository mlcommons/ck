...
#                    xrow.append(y)
                    ...
                    if prize!='':
                        x += ' &nbsp;&nbsp;Prizes from [MLCommons organizations](https://mlcommons.org), [cTuning foundation](https://cTuning.org) and [cKnowledge.org](https://www.linkedin.com/company/cknowledge): **{}**\n'.format(prize)
                        if awards!='': awards+=' , '
                        awards += prize
...
#                    st.markdown(md)
                ...
                df = pd.DataFrame(data,
                                  columns=['Challenge', 'Closing&nbsp;date', 'Extension', 'Contributor&nbsp;award and prizes from <a href="https://mlcommons.org">MLCommons&nbsp;organizations</a>, <a href="https://cTuning.org">cTuning foundation</a> and <a href="https://www.linkedin.com/company/cknowledge">cKnowledge.org</a>'])
