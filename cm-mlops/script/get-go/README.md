...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-go)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *get,tool,go,get-go*
* Output cached?: *True*
___
### Usage
...
`cm run script --tags=get,tool,go,get-go(,variations from below) (flags from below)`

*or*

`cm run script "get tool go get-go (variations from below)" (flags from below)`
...
```cm run script --tags=gui --script="get,tool,go,get-go"```
