...
1. `cm run script --tags=get,install,tflite-cmake,tensorflow-lite-cmake,from-src `

2. `cm run script "get install tflite-cmake tensorflow-lite-cmake from-src" `

3. `cm run script 5c72dab5eb88407c `
