...
### Tags
* All CM script tags: *get,android,sdk,android-sdk*
* CM CLI: *`cm run script --tags="get,android,sdk,android-sdk"`*
* CM CLI alternative: *`cm run script "get android sdk android-sdk"`*
