...
1. `cm run script --tags=get,sys-utils-min `

2. `cm run script "get sys-utils-min" `

3. `cm run script a9af7714d3d94779 `
...
```cm run script --tags=gui --script="get,sys-utils-min"```
