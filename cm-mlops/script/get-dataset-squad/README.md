...
#### CM CLI
`cm run script --tags=get,dataset,squad,language-processing,validation,training,original(,variations from below) (flags from below)`

*or*

`cm run script "get dataset squad language-processing validation training original (variations from below)" (flags from below)`

*or*

`cm run script 6651c119c3ae49b3`
