...
#### CM CLI
`cm run script --tags=get,dataset,speech,speech-recognition,librispeech,validation,audio,training,original(,variations from below) (flags from below)`

*or*

`cm run script "get dataset speech speech-recognition librispeech validation audio training original (variations from below)" (flags from below)`
