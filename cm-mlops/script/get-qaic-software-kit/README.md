...
2. `cm run script "get qaic software kit qaic-software-kit" `

3. `cm run script 3344655922694bbb `
...
```cm run script --tags=gui --script="get,qaic,software,kit,qaic-software-kit"```
