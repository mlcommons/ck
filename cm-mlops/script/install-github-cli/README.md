...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/install-github-cli)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *install,gh,github,cli,github-cli*
* Output cached?: *True*
___
### Usage
...
`cm run script --tags=install,gh,github,cli,github-cli(,variations from below) (flags from below)`

*or*

`cm run script "install gh github cli github-cli (variations from below)" (flags from below)`
...
```cm run script --tags=gui --script="install,gh,github,cli,github-cli"```
