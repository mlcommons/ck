...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/get-ck-repo-mlops)*
...
#### CM CLI
`cm run script --tags=get,ck-repo,mlops,ck-repo-mlops(,variations from below) (flags from below)`

*or*

`cm run script "get ck-repo mlops ck-repo-mlops (variations from below)" (flags from below)`
