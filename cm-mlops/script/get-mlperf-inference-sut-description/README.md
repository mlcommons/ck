...
### Tags
* All CM script tags: *get,mlperf,sut,description,system-under-test,system-description*
* CM CLI: *`cm run script --tags="get,mlperf,sut,description,system-under-test,system-description"`*
