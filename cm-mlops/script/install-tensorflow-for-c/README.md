...
* GitHub directory for this script: *[GitHub](https://github.com/mlcommons/ck/tree/master/cm-mlops/script/install-tensorflow-for-c)*
* CM meta description for this script: *[_cm.json](_cm.json)*
* CM "database" tags to find this script: *install,tensorflow,lib,lang-c*
* Output cached?: *True*
___
### Usage
...
`cm run script --tags=install,tensorflow,lib,lang-c(,variations from below) (flags from below)`

*or*

`cm run script "install tensorflow lib lang-c (variations from below)" (flags from below)`
...
```cm run script --tags=gui --script="install,tensorflow,lib,lang-c"```
