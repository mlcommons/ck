...
ACM [(ReQuEST tournaments to co-design efficient SW/HW stacks for deep learning)](https://portalparts.acm.org/3230000/3229762/fm/frontmatter.pdf),
dividiti/cTuning foundation[(CK long-term vision)](https://www.slideshare.net/GrigoriFursin/accelerating-open-science-and-ai-with-automated-portable-customizable-and-reusable-research-components-and-workflows),
