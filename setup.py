...
setup(
  ...
  data_files=[('Scripts', ['bin/ck', 
    ...
    classifiers = [
        ...
        "Topic :: Scientific/Engineering :: Artifact Evaluation",
        "Topic :: Scientific/Engineering :: Artifact Sharing",
        "Topic :: Scientific/Engineering :: Collaborative Research",
        "Topic :: Scientific/Engineering :: Reproducible Experimentation",
