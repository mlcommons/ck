...
r = cm.access({'action':'run', 'automation':'script', 'tags': 'app,mlperf,inference,generic,_python,_resnet50,_onnxruntime,_cpu,_r2.1_default', 'adr': {'mlperf-implementation': { 'version': 'master'}}, 'quiet': 'yes'})
checks.check_return(r)

r = cm.access({'action':'run', 'automation':'script', 'tags': 'app,mlperf,inference,generic,_python,_resnet50,_tf,_cpu,_r2.1_default', 'adr': {'mlperf-implementation': { 'version': 'master'}}, 'quiet': 'yes'})
checks.check_return(r)
