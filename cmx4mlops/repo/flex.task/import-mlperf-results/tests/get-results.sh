...
flextask "get mlperf results" --benchmark=training --version=4.1 --j
...
flextask "get mlperf results" --benchmark=inference --version=4.1 --j
flextask "get mlperf results" --benchmark=inference --version=4.0 --j
flextask "get mlperf results" --benchmark=inference --version=3.1 --j
